...
DEFAULT TO CLOSING: a support reply resolves the case, so recommended_actions should ALWAYS include a close_case action alongside the reply (and any account actions like credit/grant/refund). The one exception is when your reply asks the customer a question and genuinely needs their answer to proceed — then leave it open and say why in open_questions. Closing is safe: if the customer writes back, the case auto-reopens.
